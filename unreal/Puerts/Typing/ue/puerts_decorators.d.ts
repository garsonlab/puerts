...
declare module "ue" {
    namespace rpc {
        export enum FunctionFlags {
            FUNC_NetServerAPI		= 0x00000010,	// Function is executed on servers, even on server-owned actors
    ...
    enum FunctionFlags {
        ...
        FUNC_NetServerAPI       = 0x00000010,   // Allowing client to call remote server RPC on server-owned actors.
